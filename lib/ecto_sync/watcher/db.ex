defmodule EctoSync.Watcher.DB do
  ...
  defp mod do
    Application.get_env(:ecto_watch, EctoSync.Watcher.DB)[:mod] || EctoSync.Watcher.DB.Live
  end
end

defmodule EctoSync.Watcher.DB.Live do
  @moduledoc "Actual implementation of EctoSync.Watcher.DB"

  @behaviour EctoSync.Watcher.DB
